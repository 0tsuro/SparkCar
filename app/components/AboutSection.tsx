    ...
    >
      ...
      <div
        className="absolute -top-48 -right-48 w-[700px] h-[700px] rounded-full 
                   bg-gradient-to-br from-blue-300 to-blue-600 opacity-40 blur-3xl"
      />
      ...
      <div className="relative w-full max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-6 max-w-xl mx-auto lg:mx-0">En parallèle de mes études, j’ai lancé Spark’Car pour proposer un nettoyage automobile professionnel et accessible. Chaque véhicule est traité avec rigueur, passion et le souci du détail.</p>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start items-center gap-8">
              <div className="flex flex-col">
                ...
                <span className="text-sm text-gray-500">Véhicules entretenus</span>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm text-gray-500">Objectif : Propreté</span>
              </div>
            </div>
          </motion.div>

          {/* RIGHT: Photo grid (1 top long + 2 bottom) */}
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="w-full max-w-[560px]">
              ...
              <div className="relative rounded-3xl p-4 md:p-5 bg-white border border-gray-200 shadow-xl">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {/* Top long photo spans 2 columns */}
